...
class LoginWindow(QMainWindow):
    ...
    def handle_login(self):
        ...
        # verify_user may return a dict with 'error' on failure
        if isinstance(result, dict) and result.get('error'):
            QMessageBox.warning(self, "Error de Autenticación", result.get('error'))
            return
    ...
    def _load_saved_credentials(self):
        ...
        # Sólo precargar el nombre de usuario; la contraseña no se guarda ni se rellena.
        if username:
