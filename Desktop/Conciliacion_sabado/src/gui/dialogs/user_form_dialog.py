        ...
        if self.is_edit_mode:
            ...
            if password:
                if password != confirm_password:
                    ...
                    return
                if len(password) < 6:
                    QMessageBox.warning(self, "Contraseña Demasiado Corta", "La nueva contraseña debe tener al menos 6 caracteres.")
                    return
            ...
            if len(password) < 6:
                QMessageBox.warning(self, "Contraseña Demasiado Corta", "La contraseña debe tener al menos 6 caracteres.")
                return
