    ...
    def _show_details_view(self, files_data: dict):
        ...
        if self.current_record_path and os.path.exists(self.current_record_path):
            ...
            if os.path.exists(originales_dir) and os.listdir(originales_dir):
                self._add_submenu_button("Archivos Originales", "Ver archivos fuente (PDF/Excel)", "📄", self._show_original_files_view)
            ...
            if (os.path.exists(procesados_dir) and os.listdir(procesados_dir)) or has_legacy_csvs:
                self._add_submenu_button("Archivos Procesados", "Ver archivos convertidos a CSV", "⚙️", self._show_processed_files_view)
            ...
            if final_notas_path:
                self._add_file_widget("Notas Guardadas", final_notas_path, "pdf_icon.svg")
            ...
            if has_reports:
                self._add_submenu_button("Reportes Guardados", "Ver reportes generados", "📂", self._show_reports_view)
