...
class UsersView(QWidget):
    ...
    def _create_user_card(self, user_data: dict) -> QWidget:
        ...
        name_container.setFixedSize(100, 40) 
        ...
        email_group_widget.setFixedSize(260, 40) 
        ...
        username_group_widget.setFixedSize(200, 40) 
        ...
        delete_icon_filename = "eliminar_icon.svg"
        delete_icon_path = os.path.join(ASSETS_PATH, "icons", delete_icon_filename)
        ...
        delete_button.clicked.connect(partial(self.confirm_delete_user, user_data))
    ...
    def confirm_delete_user(self, user_data: dict):
        username_to_delete = user_data['nombre_usuario']
        reply = QMessageBox.question(
            self, 
            "Confirmar Eliminación", 
            f"¿Está seguro de que desea eliminar al usuario '{username_to_delete}'?",
            QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No,
            QMessageBox.StandardButton.No
        )
        
        if reply == QMessageBox.StandardButton.Yes:
            from src.logic.database import delete_user
            ...
            if success:
                ...
                if saved_username == username_to_delete:
                    clear_credentials()
